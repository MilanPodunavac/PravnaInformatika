...
/**
 * A DTO for the {@link pravna.com.myapp.domain.Optuzeni} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OptuzeniDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OptuzeniDTO)) {
            return false;
        }

        OptuzeniDTO optuzeniDTO = (OptuzeniDTO) o;
        if (this.id == null) {
            return false;
        }

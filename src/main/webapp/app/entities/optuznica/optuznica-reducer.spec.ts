...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './optuznica.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPTUZNICA_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPTUZNICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPTUZNICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPTUZNICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPTUZNICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPTUZNICA actions', async () => {
      const expectedActions = [
        {

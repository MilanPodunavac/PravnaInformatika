...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sud.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUD_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUD actions', async () => {
      const expectedActions = [
        {

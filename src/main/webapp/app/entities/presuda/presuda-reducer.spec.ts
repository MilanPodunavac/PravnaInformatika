...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './presuda.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRESUDA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRESUDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRESUDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRESUDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRESUDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRESUDA actions', async () => {
      const expectedActions = [
        {

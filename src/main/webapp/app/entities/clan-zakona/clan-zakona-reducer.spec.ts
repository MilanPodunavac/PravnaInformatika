...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLANZAKONA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLANZAKONA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLANZAKONA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLANZAKONA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLANZAKONA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLANZAKONA actions', async () => {
      const expectedActions = [
        {

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './osoba.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OSOBA_LIST actions', async () => {
    ...
    it('dispatches FETCH_OSOBA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OSOBA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OSOBA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OSOBA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OSOBA actions', async () => {
      const expectedActions = [
        {

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="pravnaInformatikaApp.osoba.home.createOrEditLabel" data-cy="OsobaCreateUpdateHeading">
            <Translate contentKey="pravnaInformatikaApp.osoba.home.createOrEditLabel">Create or edit a Osoba</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">

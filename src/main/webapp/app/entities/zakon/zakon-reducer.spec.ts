...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './zakon.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ZAKON_LIST actions', async () => {
    ...
    it('dispatches FETCH_ZAKON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ZAKON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ZAKON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ZAKON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ZAKON actions', async () => {
      const expectedActions = [
        {

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './optuzeni.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPTUZENI_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPTUZENI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPTUZENI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPTUZENI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPTUZENI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPTUZENI actions', async () => {
      const expectedActions = [
        {

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './povreda.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POVREDA_LIST actions', async () => {
    ...
    it('dispatches FETCH_POVREDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POVREDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POVREDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POVREDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POVREDA actions', async () => {
      const expectedActions = [
        {

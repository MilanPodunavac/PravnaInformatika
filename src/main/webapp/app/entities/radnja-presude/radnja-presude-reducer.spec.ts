...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RADNJAPRESUDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RADNJAPRESUDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RADNJAPRESUDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RADNJAPRESUDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RADNJAPRESUDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RADNJAPRESUDE actions', async () => {
      const expectedActions = [
        {

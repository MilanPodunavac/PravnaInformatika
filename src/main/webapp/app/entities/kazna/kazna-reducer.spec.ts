...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kazna.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KAZNA_LIST actions', async () => {
    ...
    it('dispatches FETCH_KAZNA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KAZNA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KAZNA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KAZNA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KAZNA actions', async () => {
      const expectedActions = [
        {
